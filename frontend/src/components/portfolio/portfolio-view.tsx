...
interface PortfolioViewProps {
  ...
  /** Where "View all" under the recent withdrawals leads. */
  historyHref: string
}

/**
 * One investor's portfolio: headline numbers, profile, products and latest withdrawals. Shared by the investor's own
 * overview and the staff client page, so both always show the same information.
 */
    ...
    <>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>The latest notices on this portfolio.</CardDescription>
          <CardAction>
